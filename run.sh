...
# Run main.py with taskset
CPU_LIST="0-7"

taskset --cpu-list $CPU_LIST python main.py --inpt_dir=$INPT_DIR --cfg_path=$CFG_PATH --out_dir=$RESULTS_DIR --load_ckpt=$LOAD_CKPT --terminal_logging